...
import {
  DEFAULT_FEISHU_CFG,
  FEISHU_CONFIG_FORM_SECTION,
} from './providers/feishu/feishu-cfg-form.const';
...
export const FEISHU_TYPE: IssueProviderKey = 'FEISHU';
...
export const DEFAULT_ISSUE_PROVIDER_CFGS = {
  ...
  [FEISHU_TYPE]: DEFAULT_FEISHU_CFG,
} as const;
...
export const ISSUE_PROVIDER_FORM_CFGS_MAP = {
  ...
  [FEISHU_TYPE]: FEISHU_CONFIG_FORM_SECTION,
} as const;

const T = {
  ...
  F: {
    ...
    FEISHU: {
      FORM: {
        APP_ID: 'F.FEISHU.FORM.APP_ID',
        APP_SECRET: 'F.FEISHU.FORM.APP_SECRET',
        FILTER_USER_ID: 'F.FEISHU.FORM.FILTER_USER_ID',
        FILTER_USER_ID_DESCRIPTION: 'F.FEISHU.FORM.FILTER_USER_ID_DESCRIPTION',
        FILTER_TASKLIST_IDS: 'F.FEISHU.FORM.FILTER_TASKLIST_IDS',
        FILTER_TASKLIST_IDS_DESCRIPTION: 'F.FEISHU.FORM.FILTER_TASKLIST_IDS_DESCRIPTION',
        IS_SEARCH_ISSUES_FROM_API: 'F.FEISHU.FORM.IS_SEARCH_ISSUES_FROM_API',
        IS_AUTO_POLL: 'F.FEISHU.FORM.IS_AUTO_POLL',
        IS_AUTO_ADD_TO_BACKLOG: 'F.FEISHU.FORM.IS_AUTO_ADD_TO_BACKLOG',
        IS_TWO_WAY_SYNC: 'F.FEISHU.FORM.IS_TWO_WAY_SYNC',
        IS_TWO_WAY_SYNC_DESCRIPTION: 'F.FEISHU.FORM.IS_TWO_WAY_SYNC_DESCRIPTION',
        IS_SYNC_TASK_STATUS: 'F.FEISHU.FORM.IS_SYNC_TASK_STATUS',
        IS_SYNC_TASK_CONTENT: 'F.FEISHU.FORM.IS_SYNC_TASK_CONTENT',
        IS_SYNC_COMMENTS: 'F.FEISHU.FORM.IS_SYNC_COMMENTS',
        IS_SYNC_COMMENTS_DESCRIPTION: 'F.FEISHU.FORM.IS_SYNC_COMMENTS_DESCRIPTION',
      },
      FORM_SECTION: {
        TITLE: 'F.FEISHU.FORM_SECTION.TITLE',
        HELP: 'F.FEISHU.FORM_SECTION.HELP',
      },
      ISSUE_CONTENT: {
        CREATOR: 'F.FEISHU.ISSUE_CONTENT.CREATOR',
        MEMBERS: 'F.FEISHU.ISSUE_CONTENT.MEMBERS',
        DUE_DATE: 'F.FEISHU.ISSUE_CONTENT.DUE_DATE',
        TASKLISTS: 'F.FEISHU.ISSUE_CONTENT.TASKLISTS',
        SUBTASK_COUNT: 'F.FEISHU.ISSUE_CONTENT.SUBTASK_COUNT',
      },
      S: {
        MISSING_APP_ID: 'F.FEISHU.S.MISSING_APP_ID',
        MISSING_APP_SECRET: 'F.FEISHU.S.MISSING_APP_SECRET',
        UNKNOWN_ERROR: 'F.FEISHU.S.UNKNOWN_ERROR',
        REQUEST_FAILED: 'F.FEISHU.S.REQUEST_FAILED',
        GENERAL_ERROR: 'F.FEISHU.S.GENERAL_ERROR',
        AUTH_ERROR: 'F.FEISHU.S.AUTH_ERROR',
      },
    },
    ISSUE: {
